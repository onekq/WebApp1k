...
import App from './anonymousApplications_jobPostExpiration_searchJobPosts';
...
test('allows job seekers to search job posts by keyword successfully.', async () => {
...
test('shows an error message when job search fails.', async () => {
