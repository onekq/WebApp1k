...
import App from './addCanonicalUrl_editTag_deleteTag_dislikeComment';
...
test('successfully adds a canonical URL to a post (from addCanonicalUrl_editTag)', async () => {
...
test('fails to add a canonical URL to a post due to server error (from addCanonicalUrl_editTag)', async () => {
...
test('User can edit an existing tag successfully (from addCanonicalUrl_editTag)', async () => {
...
test('User gets an error message when editing a tag fails (from addCanonicalUrl_editTag)', async () => {
  fetchMock.put('/tags/1', {
    status: 500,
...
test('User can delete a tag successfully (from deleteTag_dislikeComment)', async () => {
...
test('User gets an error message when deleting a tag fails (from deleteTag_dislikeComment)', async () => {
  fetchMock.delete('/tags/1', {
    status: 500,
...
test('successfully dislikes a comment (from deleteTag_dislikeComment)', async () => {
...
test('fails to dislike a comment (from deleteTag_dislikeComment)', async () => {
