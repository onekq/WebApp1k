...
import App from './validateEventCategory_validateEventTitle_sponsorDisplay_validateEventType';
...
test('Displays sponsors and partners on event pages (from sponsorDisplay_validateEventType)', async () => {
...
test('Displays error message when sponsors and partners are unavailable (from sponsorDisplay_validateEventType)', async () => {
...
test('Should successfully submit event with valid type (from sponsorDisplay_validateEventType)', async () => {
  fetchMock.post('/events', 200);
...
test('Should show error for not selecting event type (from sponsorDisplay_validateEventType)', async () => {
  fetchMock.post('/events', 400);
