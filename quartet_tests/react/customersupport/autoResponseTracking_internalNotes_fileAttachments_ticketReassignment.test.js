...
import App from './autoResponseTracking_internalNotes_fileAttachments_ticketReassignment';
...
test('Successfully tracks the use of auto-responses. (from autoResponseTracking_internalNotes)', async () => {
...
test('Fails to track the use of auto-responses. (from autoResponseTracking_internalNotes)', async () => {
...
test('Adding internal notes to tickets should show success message. (from autoResponseTracking_internalNotes)', async () => {
...
test('Adding internal notes to tickets should show error message when failed. (from autoResponseTracking_internalNotes)', async () => {
...
test('successfully attaches files to a ticket (from fileAttachments_ticketReassignment)', async () => {
...
test('shows error if attaching file fails (from fileAttachments_ticketReassignment)', async () => {
...
test('Reassigning ticket to a different agent should show success message. (from fileAttachments_ticketReassignment)', async () => {
...
test('Reassigning ticket to a different agent should show error message when failed. (from fileAttachments_ticketReassignment)', async () => {
