...
import App from './approveOrRemoveFlaggedArticles_flagInappropriateArticle_clearReadingHistory_retrieveReadingHistory';
...
test('Clears user reading history successfully. (from clearReadingHistory_retrieveReadingHistory)', async () => {
...
test('Fails to clear user reading history. (from clearReadingHistory_retrieveReadingHistory)', async () => {
...
test('Retrieves user reading history successfully. (from clearReadingHistory_retrieveReadingHistory)', async () => {
...
test('Fails to retrieve user reading history. (from clearReadingHistory_retrieveReadingHistory)', async () => {
