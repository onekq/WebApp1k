...
import App from './checkRoomAvailability_checkSeatAvailability_removeItemsFromItinerary_searchHotels';
...
test('checkRoomAvailability - checks room availability for selected hotels (from checkRoomAvailability_checkSeatAvailability)', async () => {
...
test('checkRoomAvailability - shows error message when room availability check fails (from checkRoomAvailability_checkSeatAvailability)', async () => {
  fetchMock.get('/api/hotels/1/rooms?dates=2023-01-01_to_2023-01-10', {
...
test('CheckSeatAvailability - check seat availability successfully (from checkRoomAvailability_checkSeatAvailability)', async () => {
...
test('CheckSeatAvailability - check seat availability fails with error message (from checkRoomAvailability_checkSeatAvailability)', async () => {
