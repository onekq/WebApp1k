...
import App from './notifyTravelAdvisories_validateHotelDetails_retrieveRecentHotelSearches_suggestActivities';
...
test('should render travel advisories and alerts (from notifyTravelAdvisories_validateHotelDetails)', async () => {
...
test('should show error if fetching travel advisories fails (from notifyTravelAdvisories_validateHotelDetails)', async () => {
...
test('validateHotelDetails - validates hotel details successfully before booking (from notifyTravelAdvisories_validateHotelDetails)', async () => {
...
test('validateHotelDetails - shows error when validation fails (from notifyTravelAdvisories_validateHotelDetails)', async () => {
  fetchMock.get('/api/hotels/1/details', {
