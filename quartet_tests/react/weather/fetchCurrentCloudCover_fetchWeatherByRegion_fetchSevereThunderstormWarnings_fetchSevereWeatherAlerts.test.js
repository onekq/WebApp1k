...
import App from './fetchCurrentCloudCover_fetchWeatherByRegion_fetchSevereThunderstormWarnings_fetchSevereWeatherAlerts';
...
test('Successfully retrieves the current cloud cover percentage for a given location (from fetchCurrentCloudCover_fetchWeatherByRegion)', async () => {
...
test('Fails to retrieve the current cloud cover percentage if the API returns an error (from fetchCurrentCloudCover_fetchWeatherByRegion)', async () => {
...
test('Fetch weather by region succeeds. (from fetchCurrentCloudCover_fetchWeatherByRegion)', async () => {
...
test('Fetch weather by region fails. (from fetchCurrentCloudCover_fetchWeatherByRegion)', async () => {
