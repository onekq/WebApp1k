...
import App from './duplicateApplicationDetection_interviewNotifications_applyForJobs_jobPostCategories';
...
test('successful duplicate application detection. (from duplicateApplicationDetection_interviewNotifications)', async () => {
...
test('failure duplicate application detection. (from duplicateApplicationDetection_interviewNotifications)', async () => {
...
test('Candidate is successfully notified about the interview. (from duplicateApplicationDetection_interviewNotifications)', async () => {
...
test('Notifying the candidate about the interview fails due to server error. (from duplicateApplicationDetection_interviewNotifications)', async () => {
