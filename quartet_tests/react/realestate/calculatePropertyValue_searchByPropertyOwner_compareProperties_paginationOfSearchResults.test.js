...
import App from './calculatePropertyValue_searchByPropertyOwner_compareProperties_paginationOfSearchResults';
...
test('successfully compares properties (from compareProperties_paginationOfSearchResults)', async () => {
...
test('fails to compare properties and shows error message (from compareProperties_paginationOfSearchResults)', async () => {
...
test('splits search results across multiple pages (from compareProperties_paginationOfSearchResults)', async () => {
...
test('fails to paginate search results due to network error (from compareProperties_paginationOfSearchResults)', async () => {
