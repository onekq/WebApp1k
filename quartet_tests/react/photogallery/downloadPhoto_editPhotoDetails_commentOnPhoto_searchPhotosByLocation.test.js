...
import App from './downloadPhoto_editPhotoDetails_commentOnPhoto_searchPhotosByLocation';
...
test('Should successfully add a comment on a photo. (from commentOnPhoto_searchPhotosByLocation)', async () => {
...
test('Should show error message when failing to add a comment. (from commentOnPhoto_searchPhotosByLocation)', async () => {
...
test('should successfully search photos by location (from commentOnPhoto_searchPhotosByLocation)', async () => {
...
test('should fail to search photos by location with error message (from commentOnPhoto_searchPhotosByLocation)', async () => {
