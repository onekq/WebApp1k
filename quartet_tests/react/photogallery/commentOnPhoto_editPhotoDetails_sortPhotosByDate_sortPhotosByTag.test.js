...
import App from './commentOnPhoto_editPhotoDetails_sortPhotosByDate_sortPhotosByTag';
...
test('Should successfully add a comment on a photo. (from commentOnPhoto_editPhotoDetails)', async () => {
...
test('Should show error message when failing to add a comment. (from commentOnPhoto_editPhotoDetails)', async () => {
...
test('edits photo details successfully (from commentOnPhoto_editPhotoDetails)', async () => {
...
test('fails to edit photo details (from commentOnPhoto_editPhotoDetails)', async () => {
