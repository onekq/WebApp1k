...
import App from './addPetMilestones_viewTrainingSessions_addHealthCheckup_searchActivityLogs';
...
test('Add health checkup successfully (from addHealthCheckup_searchActivityLogs)', async () => {
...
test('Fail to add health checkup with error (from addHealthCheckup_searchActivityLogs)', async () => {
...
test('Searches activities by keyword successfully. (from addHealthCheckup_searchActivityLogs)', async () => {
...
test('Fails to search activities with error message. (from addHealthCheckup_searchActivityLogs)', async () => {
