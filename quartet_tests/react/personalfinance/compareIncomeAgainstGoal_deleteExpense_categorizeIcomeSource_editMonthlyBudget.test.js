...
import App from './compareIncomeAgainstGoal_deleteExpense_categorizeIcomeSource_editMonthlyBudget';
...
test('successfully categorizes an income source (from categorizeIcomeSource_editMonthlyBudget)', async () => {
...
test('fails to categorize an income source (from categorizeIcomeSource_editMonthlyBudget)', async () => {
...
test('Success: Edit a monthly budget. (from categorizeIcomeSource_editMonthlyBudget)', async () => {
...
test('Failure: Edit a monthly budget. (from categorizeIcomeSource_editMonthlyBudget)', async () => {
