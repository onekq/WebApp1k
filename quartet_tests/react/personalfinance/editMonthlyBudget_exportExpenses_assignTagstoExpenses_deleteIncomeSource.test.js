...
import App from './editMonthlyBudget_exportExpenses_assignTagstoExpenses_deleteIncomeSource';
...
test('assigns tags to expenses successfully (from assignTagstoExpenses_deleteIncomeSource)', async () => {
...
test('fails to assign tags to expenses (from assignTagstoExpenses_deleteIncomeSource)', async () => {
...
test('successfully deletes an income source (from assignTagstoExpenses_deleteIncomeSource)', async () => {
...
test('fails to delete an income source (from assignTagstoExpenses_deleteIncomeSource)', async () => {
